...
Python 3.8+
Docker & Docker Compose (required for InfluxDB and Grafana)
Apache Spark (and PySpark)
Python Dependencies: (Install via pip install -r requirements.txt if available, or manually install flask, pandas, pyspark, scikit-learn, influxdb-client, requests, matplotlib, seaborn)
...
python server.py
Access the Dashboard: Open your web browser and go to http://localhost:5001 Default Login: Username: admin | Password: password123
